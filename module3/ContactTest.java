...
public class ContactTest { 
  ...
  @Test
  void contactManager_contacts_havePhonePrefix(){
    HashMap<String, Contact> contacts = ContactManager.GetContacts();
        
        for (Contact c : contacts.values()) {
            assertTrue(c.hasValidPrefix(), c.getName() + " should have a valid phone prefix");
        }
  }
} 